	...
	*/
	...
	let
		...
		txtDescAcerca =
			'Acerca de MEMORIOUS version ' + VERSION + '\n' +
			...
			'\n',
		txtDescAyuda = 'Que es?\n' +
			'MEMORIOUS es un juego de concentracion y memoria.\n' +
			'En que consiste?\n' +
	...
	*/
	...
	PIXI.loader
		.add("memorious.json")		//	PIXI.loader.add("assets/spritesheet.json").load(setup);
		.load(setup);
	...
	function setup() {
		...
		console.log("Memorious version: " + VERSION );
		...
		id = resources["memorious.json"].textures;
	...
	function PantallaInicio() {
		...
		var	txtTitulo = new PIXI.Text( "MEMORIOUS", style );
...
function initLanguage()		//	para adaptar a diferentes idiomas
{
	...
	if(sysLang == "en" || sysLang == "en") { //	ingles
		...
		txtDescAcerca =
			'About MEMORIOUS version ' + VERSION  + '\n' +
		...
		txtDescAyuda =
			'What is it? \n' +
			'MEMORIOUS is a game of concentration and memory. \n' +
		...
		txtDescAcerca =
			'Über MEMORIOUS Version ' + VERSION  + '\n' +
		...
		txtDescAyuda =
			'Was ist es?\n' +
			'MEMORIOUS ist ein Spiel der Konzentration und des Gedächtnisses.\n' +
